 ...
 * @author rogercanayon
 */
public class CollectBalance extends javax.swing.JFrame {

    /**
     * Creates new form RestockProduct
     */
    public CollectBalance() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        Lbl.setText("Collect Balance");

        DoneBtn.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        DoneBtn.setText("Done");

        balance.setEditable(false);
        balance.setBackground(new java.awt.Color(85, 88, 95));
